...
import {ProgressBarCell} from '../data/progress-bar-cell';
import {HighlightedCell} from '../data/highlighted-cell';
import {CurrencyTypeProvider} from '../data/currency-type-provider';
import {PercentTypeProvider} from '../data/percent-type-provider';
...
const AddButton = () => (
    <div style={{textAlign: 'center'}}>
        <Link to="/posts/add" className="addPost">
